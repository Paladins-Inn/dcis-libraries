...
class DeletedUserTest {
  ...
  private UserState generateUser() {
    ...
    return new DeletedUser(mockUser, mockBus);
  }
  ...
  @Test
  void shouldReturnDeletedUserWhenUserIsDetained() {
  ...
  @Test
  void shouldReturnDeletedUserWhenUserIsBanned() {
  ...
  @Test
  void shouldReturnDeletedUserWhenUserIsReleased() {
