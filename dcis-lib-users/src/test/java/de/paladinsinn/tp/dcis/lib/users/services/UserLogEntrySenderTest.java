...
import de.paladinsinn.tp.dcis.lib.users.model.UserImpl;
import de.paladinsinn.tp.dcis.lib.users.model.UserToImplImpl;
import de.paladinsinn.tp.dcis.lib.users.persistence.UserToJpaImpl;
...
@ComponentScan(basePackages = {
    "de.paladinsinn.tp.dcis.lib.commons.events",
    "de.paladinsinn.tp.dcis.lib.users",
})
@EnableJpaRepositories(basePackages = {"de.paladinsinn.tp.dcis.lib.users"})
@EntityScan(basePackages = {"de.paladinsinn.tp.dcis.lib.users"})
@XSlf4j
public class UserLogEntrySenderTest {
  ...
  private UserLogEntrySenderTest() {
  }
  
  public static UserLogEntrySenderTest createUserLogEntrySenderTest() {
    return new UserLogEntrySenderTest();
  }
